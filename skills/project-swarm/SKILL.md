...
v1.15.0, run `install.mjs --user`, link, doctor, and the read-only and writing
...
**Ship checklist:** Declare mutants in the manifest (`mutants`) and run `integrate --mutants`; do not hand-write mutant scripts.
