...
This skill runs against one shared install per machine (`{{SWARM_RUNNER}}`), not a copy inside this project. All commands below use that same runner path.
