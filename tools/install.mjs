...
export async function install(targetDirectory,{source=packageRoot}={}){
 ...
 const pairs=[['tools/preflight.mjs','tools/preflight.mjs'],['tests/preflight.test.mjs','tests/preflight.test.mjs'],['tests/live-progress.test.mjs','tests/live-progress.test.mjs'],['tools/cli-adapters.mjs','tools/cli-adapters.mjs'],['tests/cli-adapters.test.mjs','tests/cli-adapters.test.mjs'],['tools/api-adapters.mjs','tools/api-adapters.mjs'],['tests/adapters.test.mjs','tests/adapters.test.mjs'],['tools/swarm.mjs','tools/swarm.mjs'],['tests/swarm.test.mjs','tests/swarm.test.mjs'],['skills/project-swarm/SKILL.md','skills/project-swarm/SKILL.md'],['LICENSE','licenses/project-swarm/LICENSE'],['NOTICE','licenses/project-swarm/NOTICE'],['SECURITY.md','skills/project-swarm/references/SECURITY.md'],['CONTRIBUTING.md','skills/project-swarm/references/CONTRIBUTING.md'],['examples/smoke.json','coordination/swarm-smoke.json'],['examples/parallel-review.json','coordination/swarm-parallel-review.json']];
